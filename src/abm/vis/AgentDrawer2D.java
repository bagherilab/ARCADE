...
/**
 * {@link abm.vis.Drawer} for agent grids in 2D.
 * <p>
 * {@code AgentDrawer2D} converts agents in a {@link abm.env.grid.Grid} into
...
public abstract class AgentDrawer2D extends Drawer {
	...
	/**
	 * Creates a {@link abm.vis.Drawer} for drawing agent grids.
	 * 
	...
	/** {@link abm.vis.AgentDrawer2D} for drawing hexagonal agents */
	...
	/** {@link abm.vis.AgentDrawer2D} for drawing rectangular agents */
