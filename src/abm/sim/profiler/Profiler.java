 ...
 * <p>
 * More than one {@code Profiler} can be scheduled for a given {@link abm.sim.Simulation}.
 * When using {@code write}, the file will be created (including any directores)
 * if it does not exist.
 * If the file already exists, contents will be appended to the contents of the
 * file (rather than overwritting the file).
 * 
 * @version 2.3.0
 * @since   2.3
 */
