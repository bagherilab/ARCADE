...
/** 
 * Container for hexagonal geometry simulation methods.
 * <p>
...
public class HexagonalSimulation {
	...
	/**
	 * Simulation with hexagonal geometry.
	 * <p>
	 * Passes {@link abm.sim.Series} to {@link abm.env.loc.HexLocation} to
	 ...
	 */
	public HexagonalSimulation(Series series) {
		this.series = series;
	...
	protected Grid getNewGrid() { return new HexAgentGrid(); }
