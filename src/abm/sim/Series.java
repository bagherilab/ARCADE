...
import abm.env.comp.*;
import abm.sim.profiler.*;
import abm.sim.checkpoint.*;
import abm.util.*;

/** 
 * Container for a series of {@link abm.sim.Simulation} objects, differing only
 * in random seed.
 * <p>
 * The class is instantiated by parsing an XML document specifying model setup.
 * Constructors for the {@link abm.sim.Simulation} objects are built, but not
...
public class Series {
	...
	/** List of series {@link abm.agent.helper.Helper} objects */
	ArrayList<Helper> _helpers;
	
	/** List of series {@link abm.env.comp.Component} objects */
	ArrayList<Component> _components;
	
	/** List of series {@link abm.sim.profiler.Profiler} objects */
