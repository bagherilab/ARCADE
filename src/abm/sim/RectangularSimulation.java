...
/** 
 * Container for rectangular geometry simulation methods.
 * <p>
...
public class RectangularSimulation {
	...
	/**
	 * Simulation with rectangular geometry.
	 * <p>
	 * Passes {@link abm.sim.Series} to {@link abm.env.loc.RectLocation} to
	 ...
	 */
	public RectangularSimulation(Series series) {
		this.series = series;
	...
	protected Grid getNewGrid() { return new RectAgentGrid(); }
	
	protected Lattice getNewLattice(double val) {
