...
/** 
 * Implementation of {@link abm.agent.cell.Cell} for generic tissue cell.
 * <p>
 ...
 * <p>
 * {@code TissueCell} agents have two required {@link abm.agent.module.Module} 
 ...
 * {@link abm.util.Parameter} object.
...
public abstract class TissueCell implements Cell {
	...
	/** {@link abm.agent.helper.Helper} instance for this agent, may be null */
	public Helper helper;
	
	/** Current agent {@link abm.env.loc.Location} */
	private final Location location;
	
	/** Map of module names and {@link abm.agent.module.Module} instance */
	final Map<String, Module> modules;
	
	/** Map of parameter names and {@link abm.util.Parameter} instances */
	 ...
	 * <p>
	 * Cell parameters are drawn from {@link abm.util.Parameter} distributions.
	 * A new map of {@link abm.util.Parameter} objects is created using these
	 ...
	 * {@link abm.agent.module.Module} constructors.
	 * 
	 ...
	 * @param p  the map of parameter name to {@link abm.util.Parameter} objects
	 */
	...
	public void step(SimState state) {
		...
		if (age > deathAge && type != TYPE_APOPT && type != TYPE_SENES) {
	 ...
	 * <p>
	 * Schedules a {@link abm.agent.helper.Helper} to remove the cell after
	 ...
	 * <p>
	 * Schedules a {@link abm.agent.helper.Helper} to move the cell after
	 * a specific amount of time.
	 *
	 * @param sim  the simulation instance
	 */
	 ...
	 * <p>
	 * Schedules a {@link abm.agent.helper.Helper} to create a daughter cell
