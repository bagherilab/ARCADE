...
public class TissueHCell extends TissueCell {
	...
	/**
	 * Creates a healthy {@link abm.agent.cell.TissueCell} agent given specific
	 * module versions.
	 * 
	...
	/**
	 * Creates a healthy {@link abm.agent.cell.TissueCell} agent given the
