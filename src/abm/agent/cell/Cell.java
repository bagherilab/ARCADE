...
public interface Cell extends Steppable {
	...
	/** Number of different {@link abm.agent.cell.Cell} codes */
	int NUM_CODES = 3;
	...
	/**
	 * Gets the associated {@link abm.agent.helper.Helper} for the cell.
	 * 
	 * @return  the {@link abm.agent.helper.Helper} object
	 */
	Helper getHelper();
	
	/**
	 * Sets the associated {@link abm.agent.helper.Helper} for the cell.
	 * 
	 * @param helper  the {@link abm.agent.helper.Helper} object
	 */
	void setHelper(Helper helper);
	
	/**
	 * Gets the {@link abm.agent.module.Module} instance for the cell.
	 * 
	 * @param key  the name of the module
	 * @return  the {@link abm.agent.module.Module} object
	 */
	Module getModule(String key);
	
	/**
	 * Sets a given {@link abm.agent.module.Module} instance for the cell.
	 * 
	 * @param key  the name of the module
	 * @param module  the {@link abm.agent.module.Module} object
	 */
	void setModule(String key, Module module);
	
	/**
	 * Gets the current {@link abm.env.loc.Location} for the cell.
