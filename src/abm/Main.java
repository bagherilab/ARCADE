 ...
 * values, respectively.
 * The setup XML file is then parsed to produce an array of {@link abm.sim.Series}
 * objects, each of which defines replicates (differing only in random seed) of
 * {@link abm.sim.Simulation} to run.
 * <p>
 * If the VIS flag is used, only the first {@link abm.sim.Series} in the array
 * is run.
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		// Setup logger.
		Logger logger = Logger.getLogger("abm");
	...
	/**
	 * Creates an array of simulation {@link abm.sim.Series}.
	 * <p>
	 * Reads through the setup XML file using an SAX parser with custom defined
	 * content handler, which creates the {@link abm.sim.Series} objects
	 * as they are parsed.
	 ...
	 * is placed for further processing by the {@link abm.sim.Series} class.
	 * Once the end tag for a given {@code <series>} is reached, a new
	 * {@link abm.sim.Series} object is instantiated.
