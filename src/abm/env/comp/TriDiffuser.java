...
/** 
 * Extension of {@link abm.env.comp.Diffuser} for triangular lattice.
 * <p>
...
public class TriDiffuser extends Diffuser {
	...
	/**
	 * Creates a {@link abm.env.comp.Diffuser} for triangular lattices.
	 * <p>
	 ...
	 * adjusted to use a psuedo-steady state approximation.
	 * <p>
