...
/** 
 * Implementation of {@link abm.env.comp.Component} for generating concentrations.
 * <p>
 * A {@code Generator} is associated with each molecule that is generated by
 * sites through the a {@link abm.env.comp.Sites} object representing the
 * locations of sites and the amount of concentration to add.
 * The generator is scheduled after {@link abm.env.comp.Sites} so the lattice
...
public class Generator implements Component {
	 ...
	 * {@link abm.env.comp.Sites} component, which determines where and how much
