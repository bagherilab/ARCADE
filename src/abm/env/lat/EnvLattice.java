...
/** 
 * Implementation of {@link abm.env.lat.Lattice} using for loop array iteration.
 * <p>
 * Methods are written to work regardless of underlying geometry.
 * Two {@link abm.env.comp.Component} types are defined:
 * <ul>
...
public abstract class EnvLattice implements Lattice {
	...
	/**
	 * Makes a diffuser {@link abm.env.comp.Component} for the lattice.
	 * 
