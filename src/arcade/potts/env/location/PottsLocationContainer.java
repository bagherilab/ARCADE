 ...
 *
 * <p>The container can be instantiated for locations with or without regions. The voxels available
 * in a container are not necessarily all used when instantiating a {@link Location} instance.
 * Instead, the number of voxels is selected based on the associated {@link PottsCellContainer} and
...
public final class PottsLocationContainer implements LocationContainer {
     ...
     */
    private ArrayList<Voxel> select(
            int target, PottsLocationFactory factory, ArrayList<Voxel> voxels) {
