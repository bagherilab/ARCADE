 ...
 *
 * <p>Each module represents the behaviors of a cell in a given state. Module behaviors are further
 * divided by phases, such as the phases of the cell cycle for a cell in the proliferative state.
 */
public abstract class PottsModule implements Module {
     ...
     *
     * <p>Current steps count is reset to zero.
     *
