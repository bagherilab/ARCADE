...
public class PottsModuleProliferationFlyStemTwoThirdsSplitApicalReturn extends PottsModuleProliferation {
     ...
     */
    public PottsModuleProliferationFlyStemTwoThirdsSplitApicalReturn(PottsCell cell) {
        super(cell);
