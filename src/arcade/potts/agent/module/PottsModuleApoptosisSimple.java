...
public class PottsModuleApoptosisSimple extends PottsModuleApoptosis {
     ...
     * {@inheritDoc}
     *
     * <p>Cell decreases in size due to cytoplasmic water loss and nuclear pyknosis. Cell will
     * transition to late apoptosis after completing {@code STEPS_EARLY} steps at an average rate of
     * {@code RATE_EARLY}.
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * <p>Cell continues to decrease in size due to cytoplasm blebbing and nuclear fragmentation.
     * Cell will complete apoptosis after completing {@code STEPS_LATE} steps at an average rate of
     * {@code RATE_LATE}.
     */
    @Override
