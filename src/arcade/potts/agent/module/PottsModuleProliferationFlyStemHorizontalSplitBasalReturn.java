...
public class PottsModuleProliferationFlyStemHorizontalSplitBasalReturn extends PottsModuleProliferation {
     ...
     */
    public PottsModuleProliferationFlyStemHorizontalSplitBasalReturn(PottsCell cell) {
        super(cell);
    ...
    void addCell(MersenneTwisterFast random, Simulation sim) {
        ...
        Location newLocation = ((PottsLocation) cell.getLocation()).splitHalvesHorizontallyReturnBasalHalf(random); //TODO: SOPHIA CHANGE THIS
