...
class PersistenceHamiltonianConfig {
     ...
     *
     * <p>If the location has changed since the last call to this method, the vector is updated to
     * be between the previous direction and the most recent displacement direction.
     *
     ...
     *
     * <p>Displacement vector is stored until this method is called again.
     *
     ...
     *
     * <p>Calling this method does not update the stored displacement vector.
     *
     * @param x the x position of the changed voxel
     * @param y the y position of the changed voxel
     * @param z the z position of the changed voxel
