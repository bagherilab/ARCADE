...
public abstract class SurfaceHamiltonian implements Hamiltonian {
     ...
     * {@inheritDoc}
     *
     * <p>Surface energy is calculated by taking the difference in target and proposed surface for
     * the given ID. Change in surface energy is taken as the difference in differences of surface
     ...
     *
     * <p>Surface energy is calculated by taking the difference in target and proposed surface for
     * the given region. Change in surface energy is taken as the difference in differences of
     * surface energies for the source and target regions when a voxel is removed or added.
     */
    @Override
                ...
                for (Region region : regionKeys) {
                    double lambdaRegion =
                            parameters.getDouble(
                                    "surface/LAMBDA_" + region.name() + TARGET_SEPARATOR + key);
