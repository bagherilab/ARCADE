...
public class VolumeHamiltonian implements Hamiltonian {
     ...
     * {@inheritDoc}
     *
     * <p>Volume energy is calculated by taking the difference in target and proposed volume for the
     * given ID. Change in volume energy is taken as the difference in differences of volume
     ...
     *
     * <p>Volume energy is calculated by taking the difference in target and proposed volume for the
     * given region. Change in volume energy is taken as the difference in differences of volume
                ...
                for (Region region : regionKeys) {
                    double lambdaRegion =
                            parameters.getDouble(
                                    "volume/LAMBDA_" + region.name() + TARGET_SEPARATOR + key);
