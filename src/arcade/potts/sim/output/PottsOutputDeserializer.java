 ...
 *
 * <ul>
 *   <li>{@link PottsCellDeserializer} for deserializing {@link PottsCellContainer}
 *   <li>{@link PottsLocationDeserializer} for deserializing {@link PottsLocationContainer}
 *   <li>{@link VoxelDeserializer} for deserializing {@link Voxel}
 * </ul>
 */
public final class PottsOutputDeserializer {
    ...
    public static Gson makeGSON() {
        ...
        gsonBuilder.registerTypeAdapter(CellContainer.class, new PottsCellDeserializer());
        gsonBuilder.registerTypeAdapter(PottsCellContainer.class, new PottsCellDeserializer());
        gsonBuilder.registerTypeAdapter(LocationContainer.class, new PottsLocationDeserializer());
        gsonBuilder.registerTypeAdapter(
                PottsLocationContainer.class, new PottsLocationDeserializer());
    ...
    static class PottsCellDeserializer implements JsonDeserializer<PottsCellContainer> {
        @Override
        public PottsCellContainer deserialize(
    ...
    static class PottsLocationDeserializer implements JsonDeserializer<PottsLocationContainer> {
        @Override
        public PottsLocationContainer deserialize(
                JsonElement json, Type typeOfT, JsonDeserializationContext context)
                throws JsonParseException {
            JsonObject jsonObject = json.getAsJsonObject();
    ...
    static class VoxelDeserializer implements JsonDeserializer<Voxel> {
        @Override
        public Voxel deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
                throws JsonParseException {
