...
/** 
 * Extension of {@link GrowthSimulation} for hexagonal geometry.
 * <p>
...
public class HexGrowthSim extends GrowthSimulation {
	...
	/**
	 * {@link arcade.sim.GrowthSimulation} with hexagonal geometry.
	 * <p>
	 ...
	 */
	public HexGrowthSim(long seed, Series series) {
		super(seed, series);
