 ...
 * <p>
 * {@code PatchActionKill} is stepped once after a CD8 CAR T-cell binds to a
 * target tissue cell.
 * The {@code PatchActionKill} determines if cell has enough granzyme to kill.
...
public class PatchActionKill implements Action {
	...
	/**
	 * Creates a {@code PatchActionKill} for the given
	 * {@link arcade.patch.agent.cell.PatchCellCART}.
	 *
	 ...
	 */
     ...
     public PatchActionKill(PatchCellCART c, PatchCellTissue target, MersenneTwisterFast random, Series series, Parameters parameters) { 
		this.c = c;
		this.target = target;
