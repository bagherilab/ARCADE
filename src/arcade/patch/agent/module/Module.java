 ...
 * a {@link arcade.agent.cell.Cell} agent, such as metabolism, signaling networks,
 * and angiogenesis.
 * A {@code Module} can be implemented with different versions; the specific
 * class can be selected when instantiating the {@link arcade.agent.cell.Cell} agent.
 * 
 * @version 2.3.1
 * @since   2.2
 */
