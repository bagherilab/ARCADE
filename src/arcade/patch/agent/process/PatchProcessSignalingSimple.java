 ...
 *
 * <p>{@code PatchModuleSignalingSimple} represents a 5-component signaling network spanning the
...
public class PatchProcessSignalingSimple extends PatchProcessSignaling {
     ...
     *
     * <p>Uses three regulatory weights:
     *
     * <ul>
     *   <li>wG = increase in TGFa-EGFR by glucose
     *   <li>wP = increase in PLCg activation by TGFa-EGFR
     *   <li>wC = decrease in TGFa-EGFR by active PLCg
     * </ul>
     */
    Equations equations =
            (t, y) -> {
