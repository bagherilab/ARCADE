...
public abstract class PatchProcessInflammation extends PatchProcess{
	...
	/**
	 * Creates an {@code Inflammation} module for the given {@link arcade.patch.agent.PatchCell.PatchCellCART}.
	 * <p>
     ...
     *
     * @param cell  the {@link arcade.patch.agent.PatchCell.PatchCellCART} the process is associated with
