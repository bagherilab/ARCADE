...
public final class PatchInputBuilder extends InputBuilder {
    ...
    private void processPatch(MiniBox series, Box patch, Box parameters) {
        ...
        patch.add("LATTICE_VOLUME", String.valueOf(location.getVolume() / location.getNumSubcoordinates()));
        patch.add("LATTICE_AREA", String.valueOf(location.getArea() / location.getNumSubcoordinates()));
