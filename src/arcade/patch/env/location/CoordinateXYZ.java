 ...
 *
 * <p>Each coordinate is defined by (x, y, z) values. Two coordinate objects are considered equal if
 * they have matching (x, y, z) values.
 */
public final class CoordinateXYZ extends Coordinate {
     ...
     * {@inheritDoc}
     *
     * <p>Uses (x, y, z) coordinate values to calculate hash.
     */
    @Override
    public int hashCode() {
        return x + (y << 8) + (z << 16);
