 ...
 *
 * <p>Each coordinate is defined by (u, v, w, z) values. Two coordinate objects are considered equal
 * if they have matching (u, v, w, z) values.
 */
public final class CoordinateUVWZ extends Coordinate {
     ...
     * {@inheritDoc}
     *
     * <p>Uses (u, v, z) coordinate values to calculate hash.
     */
    @Override
    public int hashCode() {
        return u + (v << 8) + (z << 16);
