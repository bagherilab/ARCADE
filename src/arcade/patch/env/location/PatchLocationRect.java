 ...
 * {@link arcade.core.env.lattice.Lattice} coordinates are in (a, b).
 * Rectangular {@link arcade.core.env.lattice.Lattice} subcoordinates are
 * ordered 0 - 3, with 0 at the top left and going clockwise around.
 * <pre>
 *     ---------
 *     | 0 | 1 |
 *     ---------
...
public final class PatchLocationRect extends PatchLocation {
    ...
    /**
     * Converts rectangular {@link arcade.core.env.lattice.Lattice} coordinates
     * into a rectangular {@link arcade.core.env.grid.Grid} coordinate.
     *
