...
/** Container for patch-specific {@link arcade.core.vis.Drawer} classes for hexagonal patches. */
public abstract class PatchDrawerHex extends PatchDrawer {
    ...
    public static class PatchCells extends PatchDrawerHex {
         ...
         *
         * <p>Length and width of the drawer are expanded from given length and width of simulation
         * so each index can be drawn as a 3x3 triangle.
         *
         * @param panel the panel the drawer is attached to
         * @param name the name of the drawer
         * @param length the length of array (x direction)
    ...
    public static class PatchGrid extends PatchDrawerHex {
         ...
         *
         * <p>Length and width of the drawer are expanded from the given length and width of the
         * simulation.
         *
         * @param panel the panel the drawer is attached to
         * @param name the name of the drawer
            ...
            for (PatchLocation loc : locations) {
                ...
                for (int i = 0; i < 6; i++) {
                    add(
                            ...
                            tri.x + OFFSETS[i][0],
                            tri.y + OFFSETS[i][1],
                            tri.x + OFFSETS[(i + 1) % 6][0],
                            tri.y + OFFSETS[(i + 1) % 6][1]);
                }
            }
