...
public final class PatchVisualization extends Visualization {
    ...
    Drawer[] createHexDrawers() {
        ...
        return new Drawer[] {
                ...
                new PatchDrawerHex.PatchGrid(panels[1], "grid", length, width, height, getBox(h, 0, h, v)),
                new PatchDrawerHex.PatchGrid(panels[1], "grid", length, width, height, getBox(h, v, h, v)),
                new PatchDrawerHex.PatchGrid(panels[1], "grid", length, width, height, getBox(h, 2 * v, h, v)),
    ...
    Drawer[] createRectDrawers() {
        ...
        return new Drawer[] {
                ...
                new PatchDrawerRect.PatchGrid(panels[1], "grid", length, width, height, getBox(h, 0, h, v)),
                new PatchDrawerRect.PatchGrid(panels[1], "grid", length, width, height, getBox(h, v, h, v)),
                new PatchDrawerRect.PatchGrid(panels[1], "grid", length, width, height, getBox(h, 2 * v, h, v)),
                new PatchDrawer.Label(panels[1], "label", 0, 0, "[GLUCOSE]"),
                new PatchDrawer.Label(panels[1], "label", 0, 33, "[OXYGEN]"),
                new PatchDrawer.Label(panels[1], "label", 0, 67, "[TGFα]"),
                new PatchDrawer.Label(panels[1], "label", 33, 0, "Δ GLUCOSE"),
