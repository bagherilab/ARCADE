...
public final class PatchVisualization extends Visualization {
    ...
    Drawer[] createHexDrawers() {
                ...
                new ArrayList<>(
                        Arrays.asList(
                                ...
                                new PatchDrawerHex.PatchCells(
                                        ...
                                        maps.mapAge,
                                        null),
                                new PatchDrawerHex.PatchGrid(
                                        panels[0], "grid", length, width, height, null),
                                new PatchDrawer.Label(panels[0], "label", 0, 0, "CELLS"),
                                new PatchDrawer.Label(panels[0], "label", 0, 94, null),
                                new PatchDrawerHex.PatchLayers(
                                        panels[1],
                                        "environment:CONCENTRATION:GLUCOSE",
                                        length,
                                        width,
                                        height,
                                        maps.mapGlucose,
                                ...
                                new PatchDrawerHex.PatchLayers(
                                        panels[1],
                                        "environment:CONCENTRATION:OXYGEN",
                                        length,
                                        width,
                                        height,
                                        maps.mapOxygen,
                                ...
                                new PatchDrawerHex.PatchLayers(
                                        panels[1],
                                        "environment:CONCENTRATION:TGFA",
                                        length,
                                        width,
                                        height,
                                        maps.mapTGFa,
                                ...
                                new PatchDrawer.Label(panels[1], "label", 0, 100, "IL2"),
                                new PatchDrawerHex.PatchCells(
                                        panels[2],
                                        "agents:VOLUME",
                                        length,
        ...
        if (hasGraph) {
            drawers.add(
                    new PatchDrawer.Graph(
                            panels[1], "edges:wall", length, width, 1, getBox(h, 0, 2 * h, 2 * v)));
            drawers.add(
                    new PatchDrawer.Graph(
                            panels[1],
                            "edges:radius",
            ...
            drawers.add(
                    new PatchDrawer.Graph(
                            panels[1], "nodes", length, width, 1, getBox(h, 0, 2 * h, 2 * v)));
        } else {
            drawers.add(
                    new PatchDrawerHex.PatchLayers(
                            panels[1],
    ...
    Drawer[] createRectDrawers() {
        ...
        ArrayList<Drawer> drawers =
                new ArrayList<>(
                        Arrays.asList(
                                new PatchDrawerRect.PatchCells(
                                        panels[0],
                                        "agents:STATE",
                                        length,
                                        width,
                                ...
                                new PatchDrawerRect.PatchCells(
                                        ...
                                        maps.mapAge,
                                        null),
                                new PatchDrawerRect.PatchGrid(
                                        panels[0], "grid", length, width, height, null),
                                new PatchDrawer.Label(panels[0], "label", 0, 0, "CELLS"),
                                new PatchDrawer.Label(panels[0], "label", 0, 94, null),
                                new PatchDrawerRect.PatchLayers(
                                        panels[1],
                                        "environment:CONCENTRATION:GLUCOSE",
                                        length,
                                        width,
        ...
        if (hasGraph) {
            drawers.add(
                    new PatchDrawer.Graph(
                            panels[1], "edges:wall", length, width, 0, getBox(h, 0, 2 * h, 2 * v)));
            drawers.add(
                    new PatchDrawer.Graph(
                            panels[1],
                            "edges:radius",
            ...
            drawers.add(
                    new PatchDrawer.Graph(
                            panels[1], "nodes", length, width, 0, getBox(h, 0, 2 * h, 2 * v)));
        } else {
            drawers.add(
                    new PatchDrawerRect.PatchLayers(
                            panels[1],
