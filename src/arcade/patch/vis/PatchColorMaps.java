...
class PatchColorMaps {
    /** BurgYl colormap from <a href="https://carto.com/carto-colors/">CARTOColors</a>. */
    private static final Color[] BURGUNDY_YELLOW =
            new Color[] {
                new Color(0, 0, 0),
                new Color(112, 40, 74),
                new Color(156, 63, 93),
    ...
    /** Dark mint colormap from <a href="https://carto.com/carto-colors/">CARTOColors</a>. */
    private static final Color[] DARK_MINT =
            new Color[] {
                new Color(0, 0, 0),
                new Color(18, 63, 90),
                new Color(35, 93, 114),
    ...
    static final Colors MAP_COUNTS =
            new Colors(
                    new Color[] {
                        new Color(0, 0, 0, 0),
    ...
    /** Color map for cell populations. */
    static final Colors MAP_SITES =
            new Colors(
                    new Color[] {
                        new Color(0, 0, 0, 0), new Color(100, 100, 100), new Color(150, 150, 150),
                    },
                    new double[] {0, 1, 2});

    /** Color map for cell populations. */
    static final Colors MAP_DAMAGE =
            new Colors(
                    new Color[] {
                        new Color(0, 0, 0, 0),
                        new Color(253, 212, 158),
    ...
    static final Colors MAP_EDGE_RADIUS =
            new Colors(
                    new Color[] {
                        new Color(255, 0, 0),
                        new Color(180, 0, 0),
    ...
    static final Colors MAP_EDGE_WALL =
            new Colors(
                    new Color[] {
                        new Color(0, 100, 0), new Color(0, 255, 0), new Color(255, 255, 0)
                    },
                    new double[] {0, 5, 10});

    /** Colors for node pressures. */
    static final Colors MAP_NODE_PRESSURE =
            new Colors(
                    new Color[] {
