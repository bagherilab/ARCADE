...
public abstract class GrowthVisualization2D extends Visualization {
		...
		public Drawer[] createDrawers() {
			return new Drawer[] {
					...
					new EnvDrawer2D.Triangular(panels[1], "vegf",
							LENGTH, WIDTH, DEPTH, maps.MAP_VEGF, getBox(0,600,200)),
                    ...
                    new AuxDrawer2D.TriGrid(panels[1], "grid", LENGTH, WIDTH, DEPTH, getBox(200,600,200)),
					...
					new AuxDrawer2D.Label(panels[1], "label", 0, 100, "[VEGF]", false),
		...
		public Drawer[] createDrawers() {
			return new Drawer[] {
					...
					new EnvDrawer2D.Rectangular(panels[1], "tgfa",
							LENGTH, WIDTH, DEPTH, maps.MAP_TGF, getBox(0,400,200)),
					new EnvDrawer2D.Rectangular(panels[1], "vegf",
							LENGTH, WIDTH, DEPTH, maps.MAP_VEGF, getBox(0,600,200)),
                    ...
                    new AuxDrawer2D.RectGrid(panels[1], "grid", LENGTH, WIDTH, DEPTH, getBox(200,600,200)),
					new AuxDrawer2D.Label(panels[1], "label", 0, 0, "[GLUCOSE]", false),
					new AuxDrawer2D.Label(panels[1], "label", 0, 25, "[OXYGEN]", false),
					new AuxDrawer2D.Label(panels[1], "label", 0, 50, "[TGFα]", false),
					new AuxDrawer2D.Label(panels[1], "label", 0, 75, "[VEGF]", false),
					new AuxDrawer2D.Label(panels[1], "label", 33, 0, "Δ GLUCOSE", false),
					new AuxDrawer2D.Label(panels[1], "label", 33, 25, "Δ OXYGEN", false),
					new AuxDrawer2D.Label(panels[1], "label", 33, 50, "SITES", false),
					...
					new AuxDrawer2D.Label(panels[1], "label", 67, 0, "( RADIUS + TYPE )", false),
					new AuxDrawer2D.Label(panels[1], "label", 67, 25, "( PRESSURE + SHEAR )", false),
					new AuxDrawer2D.Label(panels[1], "label", 67, 50, "( FLOW + PERFUSION )", false),
                    new AuxDrawer2D.Label(panels[1], "label", 67, 75, "( GROWTH )", false),
	...
	public Panel[] createPanels() {
		return new Panel[]{
				...
				new Panel("[2D] Environment", 440, 10, 800, 800, this),
