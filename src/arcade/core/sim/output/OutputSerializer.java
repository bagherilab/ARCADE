 ...
 *
 * <ul>
 *   <li>{@code SeriesSerializer} for serializing {@link Series}
 *   <li>{@code MiniBoxSerializer} for serializing {@link MiniBox}
 *   <li>{@code CellListSerializer} for serializing a list of {@link CellContainer}
 *   <li>{@code LocationListSerializer} for serializing a list of {@link LocationContainer}
 * </ul>
 */
public final class OutputSerializer {
     ...
     *
     * <p>The contents of the box are formatted as:
     *
     * <pre>
     *     {
     *         "(key)" : (value),
     ...
     *
     * <p>The series object is formatted as:
     *
     * <pre>
     *     {
     *         "version": (version),
    ...
    public static final class CellListSerializer
        ...
        @Override
        public JsonElement serialize(
                ArrayList<CellContainer> src, Type typeOfSrc, JsonSerializationContext context) {
