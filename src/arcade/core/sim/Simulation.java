 ...
 *
 * <p>A {@code Simulation} consists of stepping the model for a given random seed. At the start,
 ...
 *
 * <p>A {@code Simulation} should also extend {@code SimState} from the <a
 * href="https://cs.gmu.edu/~eclab/projects/mason/">MASON</a> library. {@code SimState} manages the
...
public interface Simulation {
     ...
     *
     * <p>The {@link Series} object can be further queried for information on configuration and
     * parameters.
     *
     ...
     *
     * <p>The concrete implementing class calls this and other setup methods from the MASON library
     ...
     *
     * <p>The concrete implementing class calls this and other schedule methods from the MASON
