 ...
 *
 * <p>{@code Component} objects represent any entity that interacts with the environment. They can
 * be used for:
 *
 * <ul>
 *   <li>changing one or more layers or layer operations such as adding a drug pulse or time delayed
 *       nutrient variation or introduction of a drug
 *   <li>representing physical entities within the environment such as capillary beds or matrix
 *       scaffolding
 * </ul>
 *
 * <p>{@code Component} objects can affect {@link arcade.core.env.lattice.Lattice} layers or layer
