 ...
 *
 * <p>{@code Operation} objects represent environmental behaviors or mechanisms within a {@link
 ...
 *
 * <p>More than one {@code Operation} can be active for a given {@link
 * arcade.core.env.lattice.Lattice} object.
 *
 * <p>{@code Operation} objects are analogs to {@link arcade.core.agent.process.Process} for
