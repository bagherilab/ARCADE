 ...
 * </ul>
 * <p>
 * Unlike {@link arcade.core.agent.cell.Cell} objects, {@code Helper} objects do
 * not represent a physical entity in the model.
 * Instead, they are a generic interface for adding steppables to the model.
 */
