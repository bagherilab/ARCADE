 ...
 *
 * <p>{@code Action} objects represent any entity that interacts with agents. They can be used for:
 *
 * <ul>
 *   <li>introducing outside perturbations to the cells in the system, such as applying a treatment
 *       intervention or wounding the tissue
 *   <li>modifying individual cell or cell population states, modules, or processes, such as
 *       simulating a mutation
 * </ul>
 *
 * <p>{@code Action} objects can affect {@link arcade.core.agent.cell.Cell} populations or cell
