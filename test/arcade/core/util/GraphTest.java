...
public class GraphTest {
    ...
    public void removeEdge_called_edgeRemoved() {
        ...
        assertFalse(graph.getAllEdges().contains(edge2));
    }
    ...
    public void reverseEdge_called_reversesEdge() {
        ...
        assertTrue(graph.getAllEdges().contains(new Edge(node2, node1)));
    }
    ...
    public void reverseEdge_called_preservesOtherEdges() {
        ...
        assertTrue(graph.getAllEdges().contains(edge1));
    }
    ...
    @Test
    public void getAllDownstream_called_returnsDownstream() {
        Graph graph = new Graph();
        ...
        HashSet<Node> returned = new HashSet<Node>(graph.getAllDownstream(node0));
