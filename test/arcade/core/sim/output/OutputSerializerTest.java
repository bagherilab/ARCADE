...
public class OutputSerializerTest {
    static final JsonSerializationContext CELL_CONTEXT =
    ...
    static final JsonSerializationContext LOCATION_CONTEXT =
            new JsonSerializationContext() {
                @Override
                public JsonElement serialize(Object src) {
                    return null;
    ...
    public void serialize_forLocationContainerList_createsJSON() {
        ...
        JsonElement json =
                serializer.serialize(locations, LocationContainer.class, LOCATION_CONTEXT);
        assertEquals(expected.toString(), json.toString());
    }
}
