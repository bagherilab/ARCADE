...
public class PersistenceHamiltonianTest {
    ...
    public void constructor_called_initializesParameters() {
        ...
        series.potts.put(
                "persistence/LAMBDA_" + Region.DEFAULT.name() + TARGET_SEPARATOR + key2,
                lambdaDefault);
        series.potts.put(
                "persistence/LAMBDA_" + Region.NUCLEUS.name() + TARGET_SEPARATOR + key2,
                lambdaNucleus);
    ...
    public void getDelta_validRegions_returnsZero() {
        ...
        assertEquals(
                persistence1minus + persistence2plus,
                ph.getDelta(id, region1, region2, 0, 0, 0),
                EPSILON);
        assertEquals(
                persistence2minus + persistence1plus,
                ph.getDelta(id, region2, region1, 0, 0, 0),
                EPSILON);
    }
    ...
    public void getPersistence_validID_updatesVector() {
        ...
        PersistenceHamiltonianConfig config =
                spy(new PersistenceHamiltonianConfig(location, 0, null, 1, 1));
        ...
        double[] expected =
                new double[] {
                    initialDisplacement[0], initialDisplacement[1], -volume,
                };
    ...
    public void getPersistence_validRegions_returnsValue() {
        ...
        try {
            ...
            Field displacementField =
                    PersistenceHamiltonianConfig.class.getDeclaredField("displacement");
