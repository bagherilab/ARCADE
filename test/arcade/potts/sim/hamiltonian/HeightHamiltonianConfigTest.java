...
public class HeightHamiltonianConfigTest {
    ...
    public void getLambda_noRegion_returnsValue() {
        ...
        HeightHamiltonianConfig hhc = new HeightHamiltonianConfig(null, lambda, null);
    ...
    public void getLambda_validRegions_returnsValue() {
        ...
        HeightHamiltonianConfig hhc = new HeightHamiltonianConfig(null, lambda, lambdasRegion);
