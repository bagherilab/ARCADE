...
public class HeightHamiltonianTest {
    ...
    public void getDelta_validIDs_calculatesValue() {
        ...
        assertEquals((cell1minus1 - cell1 + cell2plus1 - cell2), hh.getDelta(id1, id2, 0, 0, 0), EPSILON);
        assertEquals((cell2minus1 - cell2 + cell1plus1 - cell1), hh.getDelta(id2, id1, 0, 0, 0), EPSILON);
    }
    ...
    public void getDelta_validRegions_calculatesValue() {
        ...
        assertEquals((regionplus1 - region),
                hh.getDelta(id, Region.DEFAULT.ordinal(), Region.NUCLEUS.ordinal(), 0, 0, 0), EPSILON);
        assertEquals((regionminus1 - region),
                hh.getDelta(id, Region.NUCLEUS.ordinal(), Region.DEFAULT.ordinal(), 0, 0, 0), EPSILON);
    }
    ...
    public void getHeight_validID_calculatesValue() {
        ...
        assertEquals(lambda * Math.pow(height - criticalHeight, 2),
                hh.getHeight(id, new Voxel(0, 0, 0), 0), EPSILON);
        assertEquals(lambda * Math.pow(3 - criticalHeight, 2),
                hh.getHeight(id, new Voxel(1, 1, 1), 1), EPSILON);
        assertEquals(lambda * Math.pow(3 - criticalHeight, 2),
                hh.getHeight(id, new Voxel(1, 1, 1), -1), EPSILON);
        assertEquals(lambda * Math.pow(height - criticalHeight + 1, 2),
                hh.getHeight(id, new Voxel(0, 0, height), 1), EPSILON);
        assertEquals(lambda * Math.pow(height - criticalHeight - 1, 2),
    ...
    public void getHeight_validRegions_calculatesValue() {
        ...
        assertEquals(lambda * Math.pow(height - criticalHeight, 2),
                hh.getHeight(id, new Voxel(0, 0, 0), region.ordinal(), 0), EPSILON);
        assertEquals(lambda * Math.pow(3 - criticalHeight, 2),
                hh.getHeight(id, new Voxel(1, 1, 1), region.ordinal(), 1), EPSILON);
        assertEquals(lambda * Math.pow(3 - criticalHeight, 2),
                hh.getHeight(id, new Voxel(1, 1, 1), region.ordinal(), -1), EPSILON);
        assertEquals(lambda * Math.pow(height - criticalHeight + 1, 2),
                hh.getHeight(id, new Voxel(0, 0, height), region.ordinal(), 1), EPSILON);
        assertEquals(lambda * Math.pow(height - criticalHeight - 1, 2),
                hh.getHeight(id, new Voxel(0, 0, 0), region.ordinal(), -1), EPSILON);
    }
