...
public class AdhesionHamiltonian2DTest {
    ...
    public void getAdhesion_validIDs_calculatesValue() {
        ...
        assertEquals(
                adhesions[1][0] * 5 + adhesions[2][0] * 2,
                ah.getAdhesion(0, 2, 2, 0) * NEIGHBORHOOD_SIZE,
                EPSILON);
        assertEquals(
                adhesions[1][0] + adhesion * 2 + adhesions[1][1] * 2,
                ah.getAdhesion(1, 2, 2, 0) * NEIGHBORHOOD_SIZE,
                EPSILON);
        assertEquals(
                adhesions[2][0] * 1 + adhesion * 5,
                ah.getAdhesion(2, 2, 2, 0) * NEIGHBORHOOD_SIZE,
                EPSILON);
        assertEquals(
                adhesions[1][0] + adhesion * 2 + adhesions[1][1] * 3,
                ah.getAdhesion(3, 2, 2, 0) * NEIGHBORHOOD_SIZE,
                EPSILON);
    }
    ...
    public void getAdhesion_validRegions_calculateValue() {
        ...
        assertEquals(
                ...
                ah.getAdhesion(1, REGION_DEFAULT, 1, 2, 0),
                EPSILON);
