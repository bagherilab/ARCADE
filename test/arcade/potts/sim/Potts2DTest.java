...
public class Potts2DTest {
    ...
    private static final double[][] AREA_MCS =
            new double[][] {
    ...
    private static final boolean[][][] BASE_TWO_NEIGHBORS_ADJACENT =
            new boolean[][][] {
                {
                    {false, true, false},
                    {true, true, false},
    ...
    private static final int[][] LINKS_TWO_NEIGHBORS_ADJACENT =
            new int[][] {
                {0}, // X
                {0}, // Y
            };
        ...
        for (int rotation = 0; rotation < 4; rotation++) {
            for (int[] combo : COMBOS_TWO_NEIGHBORS_ADJACENT_ZERO_LINKS) {
                boolean[][][] array =
                        rotate(
                                combine(
                                        BASE_TWO_NEIGHBORS_ADJACENT,
                                        combo,
                                        LINKS_TWO_NEIGHBORS_ADJACENT),
                                rotation);
                assertFalse(potts.getConnectivity(array, false));
            }
        }
    ...
    private static final boolean[][][] BASE_THREE_NEIGHBORS =
            new boolean[][][] {
                {
                    {false, true, false},
                    {true, true, false},
    ...
    private static final int[][] LINKS_THREE_NEIGHBORS =
            new int[][] {
                {0, 2}, // X
                {0, 0}, // Y
            };
    ...
    private static final int[][] COMBOS_THREE_NEIGHBORS_ONE_LINK =
            new int[][] {
                {0}, {1},
            };

    private static final int[][] COMBOS_THREE_NEIGHBORS_TWO_LINKS =
            new int[][] {
                {0, 1},
            };
    ...
    public void getConnectivity_threeNeighborsZeroLinks_returnsFalse() {
        for (int rotation = 0; rotation < 4; rotation++) {
            for (int[] combo : COMBOS_THREE_NEIGHBORS_ZERO_LINKS) {
                boolean[][][] array =
                        rotate(
                                combine(BASE_THREE_NEIGHBORS, combo, LINKS_THREE_NEIGHBORS),
                                rotation);
                assertFalse(potts.getConnectivity(array, false));
            }
        }
