...
public class PottsModuleProliferationFlyStemTest {
    ...
    //     PottsModuleProliferationFlyStemWT.getCellSplitLocation(stemCell);
    ...
    // @Test
    // public void
    // getDivisionPlaneWithRotationalVariance_WT_callsRotateVectorWithCorrectParameters() {
    //     when(stemCell.getStemType()).thenReturn(PottsCellFlyStem.StemType.WT);
    ...
    //     module = new PottsModuleProliferationFlyStemWT(stemCell);
    ...
    //     when(parameters.getString("proliferation/DIFFERENTIATION_RULESET")).thenReturn("volume");
    //     module = spy(new PottsModuleProliferationFlyStemWT(stemCell));
