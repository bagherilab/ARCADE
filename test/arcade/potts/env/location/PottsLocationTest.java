...
public class PottsLocationTest {
    ...
    public void splitVoxels_YZPlaneDirectionRandomZero_updatesLists() {
        ...
        Plane yzPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.YZ_PLANE.getVector());
    ...
    public void splitVoxels_ZXPlaneDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane zxPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.ZX_PLANE.getVector());
    ...
    public void splitVoxels_XYPlaneDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane xyPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.XY_PLANE.getVector());
    ...
    public void splitVoxels_negativeXYDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane negativeXYPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.NEGATIVE_XY.getVector());
    ...
    public void splitVoxels_positiveXYDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane positiveXYPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.POSITIVE_XY.getVector());
    ...
    public void splitVoxels_negativeYZDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane negativeYZPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.NEGATIVE_YZ.getVector());
    ...
    public void splitVoxels_positiveYZDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane positiveYZPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.POSITIVE_YZ.getVector());
    ...
    public void splitVoxels_negativeZXDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane negativeZXPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.NEGATIVE_ZX.getVector());
    ...
    public void splitVoxels_positiveZXDirectionRandomZero_updatesLists() {
        ...
        Voxel center = loc.getCenter();
        Plane positiveZXPlane = new Plane(new Int3D(center.x, center.y, center.z), Direction.POSITIVE_ZX.getVector());
    ...
    @Test
    public void split_noOffsetsNoDirectionRandomDoubleZero_splitsVoxelsCorrectly() {
        ArrayList<Voxel> voxels = new ArrayList<>();
        ...
        // Only diameter in mock is YZ plane, so plane of division will be ZX plane
        // Expected voxels in splitVoxels: y >= 1, including the plane where y = 1
        // (because of randomDoubleZero as RNG)
        // Expected voxels in locVoxels: y < 1
        ...
        // Verify that the voxels were split correctly
        assertEquals(locVoxels, loc.voxels);
        assertEquals(splitVoxels, split.voxels);
    }
    ...
    public void split_withOffsetsNoDirection_splitsVoxelsCorrectly() {
        ...
        // expected locVoxels: y >= 1
        // expected splitVoxels: y < 1
        for (Voxel voxel : voxels) {
            if (voxel.y >= 1) {
                splitVoxels.add(voxel);
            } else {
    ...
    public void split_withOffsetsWithDirectionWithProbability_splitsVoxelsCorrectly() {
        ...
        // expected locVoxels: x - y + 1 >= 0
        // expected splitVoxels: x - y + 1 < 0
        for (Voxel voxel : voxels) {
    ...
    @Test
    public void split_withOddAnglePlaneThroughPointAndProbabilityOne_splitsVoxelsCorrectly() {
        ArrayList<Voxel> voxels = new ArrayList<>();
        ArrayList<Voxel> locVoxels = new ArrayList<>();
        ArrayList<Voxel> splitVoxels = new ArrayList<>();
        ...
        Int3D planePoint = new Int3D(1, 2, 1);
        Int3D normalVector = new Int3D(1, 2, 3);
        Plane plane = new Plane(planePoint, normalVector);

        // Expected locVoxels: x + 2y + 3z < 8
        // Expected splitVoxels: x + 2y + 3z >= 8
        for (Voxel voxel : voxels) {
            int value = voxel.x + 2 * voxel.y + 3 * voxel.z;
            if (value < 8) {
                locVoxels.add(voxel); // Voxels opposite the normal vector
            } else {
                splitVoxels.add(voxel); // Voxels on the normal vector side and on the plane
            }
        }
