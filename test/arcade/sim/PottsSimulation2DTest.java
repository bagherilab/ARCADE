...
public class PottsSimulation2DTest {
	...
	public void makeCenters_onePopulationThreeSideExactEqualSize_createsCenters() {
		...
		series._length = 12;
		series._width = 12;
		when(series.getParam(1, "CRITICAL_VOLUME")).thenReturn(9.*Simulation.DS);
	...
	public void makeCenters_multiplePopulations_createsCenters() {
		...
		when(series.getParam(3, "CRITICAL_VOLUME")).thenReturn(25.*Simulation.DS);
		when(series.getParam(4, "CRITICAL_VOLUME")).thenReturn(9.*Simulation.DS);
	...
	public void makeCell_onePopulationNoTags_createsObject() {
		...
		Cell cell = sim.makeCell(cellID, population, new int[] { 0, 0 });
		
		assertTrue(cell instanceof PottsCell2D);
		assertTrue(cell.getLocation() instanceof PottsLocation2D);
	...
	public void makeCell_onePopulationWithTags_createsObject() {
		...
		assertTrue(cell instanceof PottsCell2D);
		assertTrue(cell.getLocation() instanceof PottsLocations2D);
