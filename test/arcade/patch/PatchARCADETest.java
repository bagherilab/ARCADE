...
public class PatchARCADETest {
    ...
    public void main_noVis_savesFiles(@TempDir Path path) throws Exception {
        ...
        String[] args = new String[] { "patch", setupFile.toString(), path.toAbsolutePath().toString() };
        ARCADE.main(args);
    ...
    public void main_withVis_savesNothing(@TempDir Path path) throws Exception {
        ...
        String[] args = new String[] { "patch", setupFile.toString(), path.toAbsolutePath().toString(), "--vis" };
        ARCADE.main(args);
