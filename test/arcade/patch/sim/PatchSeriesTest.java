...
public class PatchSeriesTest {
    ...
    private static final String[] PROCESS_IDS =
            new String[] {
                randomString().toLowerCase(), randomString().toLowerCase(),
            };

    private static final String[] PATCH_PARAMETER_NAMES =
            new String[] {
                "PATCH_PARAMETER_1", "PATCH_PARAMETER_2", "PATCH_PARAMETER_3",
            };

    private static final double[] PATCH_PARAMETER_VALUES =
            new double[] {
