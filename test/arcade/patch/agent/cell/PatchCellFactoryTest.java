...
public class PatchCellFactoryTest {
    ...
    @Test
    public void createCells_withICEqualMU_createsList() {
    ...
    @Test
    public void createCells_withICEqualNumber_createsList() {
        int count = randomIntBetween(1, 10);
        PatchSeries series = createSeries(new int[] {count}, new String[] {"COUNT"});
        ...
        parameters.put("CELL_VOLUME_MU", volumeMu);
        parameters.put("CELL_VOLUME_SIGMA", volumeSigma);
        parameters.put("CELL_VOLUME_IC", numberString);
        parameters.put("CELL_HEIGHT", height);
        parameters.put("CELL_AGE", age);
        parameters.put("COMPRESSION_TOLERANCE", compression);
        ...
        for (int i : factory.popToIDs.get(1)) {
            PatchCellContainer patchCellContainer = factory.cells.get(i);
            assertEquals(50, patchCellContainer.criticalVolume, EPSILON);
            assertEquals(height + compression, patchCellContainer.criticalHeight, EPSILON);
            assertEquals(age, patchCellContainer.age);
            assertEquals(0, patchCellContainer.divisions);
        }
    ...
    @Test
    public void createCells_withICEqualMin_createsList() {
        int count = randomIntBetween(1, 10);
        PatchSeries series = createSeries(new int[] {count}, new String[] {"COUNT"});

        double volumeMin = randomDoubleBetween(1, 10);
        double volumeMax = randomDoubleBetween(1, 10);
        double height = randomDoubleBetween(1, 10);
        int age = randomIntBetween(1, 100);
        double compression = randomDoubleBetween(1, 10);

        MiniBox parameters = new MiniBox();
        parameters.put("(DISTRIBUTION)/CELL_VOLUME", "UNIFORM");
        parameters.put("CELL_VOLUME_MIN", volumeMin);
        parameters.put("CELL_VOLUME_MAX", volumeMax);
        parameters.put("CELL_VOLUME_IC", "MIN");
        parameters.put("CELL_HEIGHT", height);
        parameters.put("CELL_AGE", age);
        parameters.put("COMPRESSION_TOLERANCE", compression);
        ...
        for (int i : factory.popToIDs.get(1)) {
            PatchCellContainer patchCellContainer = factory.cells.get(i);
            assertEquals(volumeMin, patchCellContainer.criticalVolume, EPSILON);
            assertEquals(height + compression, patchCellContainer.criticalHeight, EPSILON);
            assertEquals(age, patchCellContainer.age);
            assertEquals(0, patchCellContainer.divisions);
        }
    ...
    @Test
    public void createCells_withICNotMatchDistribution_returnsNaN() {
        int count = randomIntBetween(1, 10);
        PatchSeries series = createSeries(new int[] {count}, new String[] {"COUNT"});
        ...
        for (int i : factory.popToIDs.get(1)) {
            PatchCellContainer patchCellContainer = factory.cells.get(i);
            assertEquals(Double.NaN, patchCellContainer.criticalVolume, EPSILON);
            assertEquals(height + compression, patchCellContainer.criticalHeight, EPSILON);
            assertEquals(age, patchCellContainer.age);
            assertEquals(0, patchCellContainer.divisions);
        }
