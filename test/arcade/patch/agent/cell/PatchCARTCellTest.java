...
public class PatchCARTCellTest {
    ...
    public static void setupMocks() {
        ...
        cellDefaultCD4 = new PatchCellCARTCD4(cellID, cellParent, cellPop, cellState, cellAge, cellDivisions,
                locationMock, parametersMock, cellVolume, cellHeight, cellCriticalVolume, cellCriticalHeight);
        
        cellDefaultCD8 = new PatchCellCARTCD8(cellID, cellParent, cellPop, cellState, cellAge, cellDivisions,
                locationMock, parametersMock, cellVolume, cellHeight, cellCriticalVolume, cellCriticalHeight);
    ...
    public void bind_target_grabs_all_neighbors() {
        ...
        when(locationMock.getNeighbors()).thenReturn(new ArrayList<Location>(Arrays.asList(dummyNeighbor)));
        ...
        //make new cell
        PatchCellCARTCD8 sampleCellCD8 = new PatchCellCARTCD8(cellID, cellParent, cellPop, cellState, cellAge, cellDivisions,
                locationMock, parametersMock, cellVolume, cellHeight, cellCriticalVolume, cellCriticalHeight);
